...
compatibility: Requires {{MCP_PREREQUISITE}} with AWS credential or SSO auth, AWS CLI v2, an AWS Transform mainframe reimagine connector (S3 + Amazon Neptune), and unzip plus python3 on PATH.
license: Apache-2.0
metadata:
  author: tarun.goel
  version: "1.1.1"
