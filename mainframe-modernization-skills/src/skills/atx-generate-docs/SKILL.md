...
1. **Load the suite skill.** Read `{{SKILLS_ROOT}}/atx-app-documentation/SKILL.md`. Do not
...
2. **Run the gate.** Execute:
   ...
   ```
   {{SKILLS_ROOT}}/atx-app-documentation/scripts/build_coverage.py --mfre .atx/mfre
   ```
