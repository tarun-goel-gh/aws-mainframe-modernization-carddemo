...
| Requirement | Notes |
|---|---|
| the AWS Transform MCP server declared in `.mcp.json` | AWS credential or SSO auth |
...
The skill activates from natural language in Claude Code. You do not call the scripts yourself in
