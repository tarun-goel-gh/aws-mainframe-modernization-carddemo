...
| Requirement | Notes |
|---|---|
| the AWS Transform MCP server declared in `config.toml` | AWS credential or SSO auth |
...
The skill activates from natural language in Codex. You do not call the scripts yourself in
