...
1. **Load the suite skill.** Read `.codex/skills/atx-app-documentation/SKILL.md`. Do not
...
2. **Run the gate.** Execute:
   ...
   ```
   .codex/skills/atx-app-documentation/scripts/build_coverage.py --mfre .atx/mfre
   ```
