...
| Requirement | Notes |
|---|---|
| the aws-transform Kiro power (MCP server) | AWS credential or SSO auth |
...
The skill activates from natural language in Kiro. You do not call the scripts yourself in
